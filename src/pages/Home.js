    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-sm px-8 py-3 flex justify-between items-center sticky top-0 z-10">
        ...
        <div className="flex gap-8 items-center">
          <Link to="/products" className="text-gray-600 hover:text-blue-800 font-medium transition">
            პროდუქტები
          </Link>
...
<div className="max-w-6xl mx-auto px-8 py-16">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
    {products.map(p => (
      <div key={p.id} className="bg-white rounded-2xl shadow hover:shadow-lg transition-all duration-300 overflow-hidden group cursor-pointer">
